...
#define SSD_HOURS_TENS_DR       (GPIO_PORTB_DATA)
#define SSD_HOURS_TENS_CR       (GPIO_PORTB_CONTROL)
#define SSD_HOURS_TENS_PIN      (GPIO_PIN_7)

#define SSD_HOURS_UNITS_DR      (GPIO_PORTB_DATA)
#define SSD_HOURS_UNITS_CR      (GPIO_PORTB_CONTROL)
#define SSD_HOURS_UNITS_PIN     (GPIO_PIN_6)

#define SSD_MINUTES_TENS_DR     (GPIO_PORTB_DATA)
#define SSD_MINUTES_TENS_CR     (GPIO_PORTB_CONTROL)
#define SSD_MINUTES_TENS_PIN    (GPIO_PIN_5)

#define SSD_MINUTES_UNITS_DR    (GPIO_PORTB_DATA)
#define SSD_MINUTES_UNITS_CR    (GPIO_PORTB_CONTROL)
